import pytest
from neutro.src.chain import voting_token_transaction as vt_transaction
from neutro.src.chain.voting_token_transaction import Vt_Transaction
from neutro.src.util import cryptoutil
from neutro.src.util import wallet


def test_vt_transaction():
    ...
    vt_amount = 100
    nto_amount = 100
    vt_tx = Vt_Transaction(sender, receiver, vt_amount, nto_amount)
...
def test_vt_tx_from_json():
    ...
    vt_amount = 100
    nto_amount = 100
    t1 = Vt_Transaction(sender, receiver, vt_amount, nto_amount)
    t2 = vt_transaction.from_json_string(t1.string())
...
def test_verify_vt_tx_signature():
    ...
    vt_amount = 100
    nto_amount = 100
    t = Vt_Transaction(sender, receiver, vt_amount, nto_amount)
    sender_wallet.sign_vt_transaction_sender(t)
    ...
    # sign with receiver
    receiver_wallet.sign_vt_transaction_receiver(t)
    # should work
    assert cryptoutil.verify_transaction_sig(
